...
class MainWindow(Adw.PreferencesWindow):
    __gtype_name__ = 'MyHyprlandSettingsWindow'
...
class MyApp(Adw.Application):
    ...
    configFolderName = "my-hyprland/settings/my-hyprland-settings" # config folder name
    ...
    def __init__(self, **kwargs):
        super().__init__(application_id='com.waltosoft.my.hyprland.settings', flags=Gio.ApplicationFlags.DEFAULT_FLAGS)
    ...
    def do_activate(self):
        ...
        win.present()
        print (":: Welcome to My Hyprland Settings App")
    ...
    # File setup
    def runSetup(self):
        # Create my-hyprland-settings in .config folder
    ...
    def on_about(self, widget, _):
        ...
        dialog = Adw.AboutWindow(
            ...
            application_name="My Hyprland Settings App",
            developer_name="Billy Walton",
            version="1.0.0",
            website="https://github.com/waltosoft/my-hyprland-settings",
            issue_url="https://github.com/waltosoft/my-hyprland-settings/issues",
            support_url="https://github.com/waltosoft/my-hyprland-settings/issues",
            copyright="© 2024 Billy Walton",
